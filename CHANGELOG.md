...
- **OpenSpec Integration** - Added spec-driven development framework
  - `openspec/project.md` - Project context with tech stack and conventions
  - `openspec/AGENTS.md` - AI assistant workflow instructions
  - `.claude/CLAUDE.md` - Development Workflow section
  - `docs/PR_CHECKLIST.md` - Streamlined from 247 to 92 lines with OpenSpec-first approach
  - Claude Code and OpenCode slash command support
...
[Unreleased]: https://github.com/memorysaver/looplia-core/compare/v0.8.1...HEAD
[0.8.1]: https://github.com/memorysaver/looplia-core/compare/v0.8.0...v0.8.1
