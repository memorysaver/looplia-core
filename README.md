...
| [DESIGN-0.7.0.md](./docs/archive/DESIGN-0.7.0.md) | Skill Registry System design (archived) |
...
| [RELEASE_CHECKLIST.md](./docs/RELEASE_CHECKLIST.md) | Development and release workflow |
