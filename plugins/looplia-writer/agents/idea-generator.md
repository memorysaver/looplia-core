...
1. Read ContentSummary from `sandbox/{id}/outputs/summary.json` (generated by content-analyzer)
...
6. Write output to: `sandbox/{id}/outputs/ideas.json`

## Output

Write to: `sandbox/{id}/outputs/ideas.json`
