...
These are the current, authoritative documents for the v0.4.0 architecture:

| Document | Purpose | Audience |
|----------|---------|----------|
| [DESIGN-0.4.0.md](./DESIGN-0.4.0.md) | Architecture overview, folder structure, command framework, streaming events | Developers, Architects |
...
The primary architecture document covering:
...
2. Read [DESIGN-0.4.0.md](./DESIGN-0.4.0.md) for architecture overview
3. Review [AGENTIC_CONCEPT-0.2.md](./AGENTIC_CONCEPT-0.2.md) for the agent system design
...
└─────────────────────────────────────────────────────────────────────────────┘
                    ...
                    ▼                ▼                ▼
          ┌─────────────────┐ ┌───────────────┐ ┌───────────────┐
          │ DESIGN-0.4.0.md │ │ AGENTIC_      │ │TEST_PLAN-0.2 │
          │ (Architecture)  │ │ CONCEPT-0.2   │ │  (Testing)   │
          │                 │ │ (Agent Design)│ │              │
          └────────┬────────┘ └───────┬───────┘ └──────────────┘
                   │                  │
                   │                  │
...
- **DESIGN-0.4.0.md** documents the implementation architecture
...
*This README provides navigation for Looplia-Core v0.4.0 documentation.*
